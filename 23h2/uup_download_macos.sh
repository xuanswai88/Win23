...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=9443fe15-1a5f-4418-904a-0c242bdd0235&pack=en-gb&edition=professional&aria2=2"
if [ $? != 0 ]; then
